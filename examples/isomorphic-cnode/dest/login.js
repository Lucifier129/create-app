...
/***/ function(module, exports, __webpack_require__) {
	...
	var _model = __webpack_require__(583);
	    ...
	    function _class() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(args))), _this), _this.name = 'Login', _this.View = _view2.default, _this.actions = actions, _this.initialState = {
	            ...
	            switchLoading: function switchLoading() {
	                var status = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
	                var UPDATE_FIELD = this.store.actions.UPDATE_FIELD;
	                        ...
	                        while (1) {
	                            switch (_context.prev = _context.next) {
	                                case 0:
	                                    ...
	                                    FETCH_USER_INFO = _store$actions.FETCH_USER_INFO;
	                    ...
	                    return regeneratorRuntime.wrap(function _callee3$(_context3) {
	                        while (1) {
	                            switch (_context3.prev = _context3.next) {
	                                case 0:
	                                    _store$actions2 = _this3.store.actions;
	                                    GET_TOKEN_BY_IMG = _store$actions2.GET_TOKEN_BY_IMG;
	                                    UPDATE_FIELD = _store$actions2.UPDATE_FIELD;
	                                    file = currentTarget.files[0];
	                                    reader = new FileReader();


	                                    reader.onload = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
	                                        var dataURL, base64;
